...
I work where biomedical data, product, and AI meet: integrating and modeling data, and shaping the products built on it.
...
**[scrna-seq-pbmc3k](https://github.com/ramibaghdan/scrna-seq-pbmc3k)**: a single-cell RNA-seq clustering workflow on public 10x data using scanpy, from QC through clustering and cell-type annotation.
